...
public class UsuarioController {
    ...
    @Operation(summary = "Criar um novo usuário.",
            ...
            @ApiResponse(responseCode = "422", description = "Recurso não processador por dados de entrada inválidos",
    ...
    @Operation(summary = "Listar usuário por ID.",
            description = "Recurso para listar usuario ID.",
    ...
    @Operation(
            ...
            description = "Recurso para atualizar o usuário.",
            responses = {
                    @ApiResponse(
    ...
    @Operation(summary = "Deletar um usuário.",
            description = "Recurso para deletar um usuário.",
