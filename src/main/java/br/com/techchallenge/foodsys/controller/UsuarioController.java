...
public class UsuarioController {
        ...
        @Operation(summary = "Criar um novo usuário.", description = "Recurso para criar um novo usuário.",
                        ...
                        responses = {
                                        ...
                                        @ApiResponse(responseCode = "400", description = "Usuário já existente.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BadRequestException.class))),

                                        @ApiResponse(responseCode = "401", description = "Recurso não processador por dados de entrada inválidos", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BadRequestException.class)))
                        })
