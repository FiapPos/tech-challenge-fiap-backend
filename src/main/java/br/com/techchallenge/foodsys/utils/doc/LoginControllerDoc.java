...
public interface LoginControllerDoc {
    ...
    @Operation(summary = "Atualizar senha do usuário.",
               description = "Recurso para atualizar a senha de um usuário.",
               responses = {
    ...
    ResponseEntity<Map<String, String>> atualizaSenha(@RequestBody @Valid AtualizaCredenciaisComandoDto atualizaCredenciaisComandoDto,
