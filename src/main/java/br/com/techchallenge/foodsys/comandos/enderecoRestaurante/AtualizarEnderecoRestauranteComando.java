...
public class AtualizarEnderecoRestauranteComando {
    ...
    private void validarDto(AtualizarEnderecoRestauranteComandoDto dto) {
        if (!isPeloMenosUmCampoPreenchido(dto)) {
            throw new BadRequestException("atualizar.endereco.nenhum.campo");
        }
    }

    private boolean isPeloMenosUmCampoPreenchido(AtualizarEnderecoRestauranteComandoDto dto) {
