...
class ValidarDadosDelecaoEnderecoTest {
    ...
    private ValidarDadosDelecaoEndereco validarDadosDelecaoEndereco;

    @BeforeEach
    void setUp() {
        MockitoAnnotations.openMocks(this);
        validarDadosDelecaoEndereco = new ValidarDadosDelecaoEndereco(
    ...
    void deveLancarExcecaoQuandoUsuarioNaoEProprietario() {
        ...
        doThrow(new BadRequestException("usuario.nao.proprietario"))
                .when(validarProprietarioEndereco).validarProprietarioEndereco(endereco, usuarioId, restauranteId);
