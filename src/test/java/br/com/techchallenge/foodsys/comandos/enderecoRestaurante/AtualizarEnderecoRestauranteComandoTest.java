...
public class AtualizarEnderecoRestauranteComandoTest {
    ...
    @Mock
    private ValidarDadosAtualizacaoEnderecoRestaurante validarDadosAtualizacaoEndereco;
    @Mock
    ...
    void deveAtualizarEnderecoComCamposCorretos() {
        ...
        assertEquals("99999-999", resultado.getCep());
