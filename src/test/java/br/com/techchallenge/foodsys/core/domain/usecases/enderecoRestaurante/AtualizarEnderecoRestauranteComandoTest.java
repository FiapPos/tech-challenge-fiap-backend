...
class AtualizarEnderecoRestauranteComandoTest {
    ...
    @InjectMocks
    private AtualizarEnderecoRestauranteComando atualizarEnderecoRestauranteComando;
    ...
    @Test
    void deveAtualizarEnderecoRestauranteComSucesso() {
        // Arrange
        dto.setRua("Nova Rua");
        ...
        doNothing().when(validadorPermissoes).validarGerenciamentoRestaurante(1L);

        // Act
        Endereco resultado = atualizarEnderecoRestauranteComando.execute(1L, dto, 1L);
        ...
        verify(validadorPermissoes).validarGerenciamentoRestaurante(1L);
    ...
    @Test
    void deveNaoAtualizarQuandoRuaENull() {
        // Arrange
        dto.setRua(null);
        dto.setCep("54321-987");
        ...
        // Assert
        assertEquals("Rua Antiga", resultado.getRua()); // Não deve mudar
        assertEquals("54321-987", resultado.getCep());
        assertEquals("100", resultado.getNumero());
    }

    @Test
    void deveNaoAtualizarQuandoCepENull() {
        // Arrange
        dto.setRua("Nova Rua");
        dto.setCep(null);
        ...
        // Assert
        assertEquals("Nova Rua", resultado.getRua());
        assertEquals("12345-000", resultado.getCep()); // Não deve mudar
        assertEquals("100", resultado.getNumero());
    }

    @Test
    void deveNaoAtualizarQuandoNumeroENull() {
        // Arrange
        dto.setRua("Nova Rua");
        dto.setNumero(null);
        ...
        assertEquals("Nova Rua", resultado.getRua());
        assertEquals("12345-000", resultado.getCep());
        assertEquals("100", resultado.getNumero()); // Não deve mudar
    }
    ...
    void deveLancarExcecaoQuandoNenhumCampoPreenchido() {
        ...
        assertThrows(BadRequestException.class, () -> 
            atualizarEnderecoRestauranteComando.execute(1L, dto, 1L));
        
        verify(validarProprietarioEndereco, never()).execute(any(), any());
        verify(validadorPermissoes, never()).validarGerenciamentoRestaurante(any());
        verify(validarEnderecoExistente, never()).execute(any());
    }

    @Test
    void deveValidarPermissoesAntesDeAtualizar() {
        // Arrange
        dto.setRua("Nova Rua");
